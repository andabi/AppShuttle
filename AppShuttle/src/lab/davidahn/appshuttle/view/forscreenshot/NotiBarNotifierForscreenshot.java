...
import lab.davidahn.appshuttle.view.AppShuttleMainActivity;
...
public class NotiBarNotifierForscreenshot {
...
//	private LayoutInflater layoutInflater;
	...
	private static NotiBarNotifierForscreenshot notifier = new NotiBarNotifierForscreenshot();
	private NotiBarNotifierForscreenshot(){
		notificationManager = (NotificationManager)cxt.getSystemService(Context.NOTIFICATION_SERVICE);
	}
	public static NotiBarNotifierForscreenshot getInstance(){
		return notifier;
	}
	...
	public void updateNotibar() {
		...
		viewableUserBhvList.addAll(MockObjectForScreenshot.getFakeViewableUserBhvList(PresentBhvFragmentForScreenshot.class));
